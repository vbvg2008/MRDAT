...
[DepGIC,y]=ginput(1);
hold on
scatter(DepGIC,y,'filled');
hold off
handles.change = 1;
handles.newGIC = DepGIC;
handles.newy = y;
...
if handles.change ==1 
    ...
    Well_name = total_list_info{current_idx,2};
    Case_name = case_data{case_idx}.name;
    DepGIC = handles.newGIC;
    y =handles.newy;
    eval(['case_data{case_idx}.Diagnostics.MHA.',Well_name,'.DepGIC = DepGIC;']);
