function case_data = ChanDiagnosticPlots_WOR_byField(case_data, save_flag)
...
%
%SYNOPSIS:
%   case_data = ChanDiagnosticPlots_WOR_byField(case_data, save_flag)
%
%DESCRIPTION:
...
for case_idx=1:num_cases
    ...
    case_data{case_idx,1}.Diagnostics.Field.ChanPlotFlag = ChanPlotFlag;    
end
